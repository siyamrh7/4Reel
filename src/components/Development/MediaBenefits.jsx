  ...
  const benefits = [
    {
      title: "CLEAN ",
      subtitle: "CODE",
      description: "We build fast, scalable, and secure websites using modern frameworks that keep your product stable and future-ready.",
      color: "text-[#2593DA]"
    },
    {
      title: "PERFORMANCE  ",
      subtitle: "FIRST",
      description: "Speed, SEO, and smooth functionality aren’t afterthoughts — they’re built into the foundation from day one.",
      color: "text-[#2593DA]"
    },
    {
      title: "SEAMLESS ",
      subtitle: "HANDOFF",
      description: "Our code is structured, documented, and ready for any team to pick up, expand, or integrate without friction.",
      color: "text-[#2593DA]"
    }
  ];
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-light leading-tight">
            Turning ideas into fast,<br /> functional sites
          </h1>
        </div>
