  ...
  const benefits = [
    {
      title: "TIME-SAVING",
      subtitle: "EFFICIENCY",
      description: "Saves time and increases efficiency by organizing content months in advance.",
      color: "text-[#2593DA]"
    },
    {
      title: "CONSISTENT",
      subtitle: "ENGAGEMENT",
      description: "Maintains consistent posting to keep active audience engagement.",
      color: "text-[#2593DA]"
    },
    {
      title: "QUALITY AND",
      subtitle: "STRUCTURE",
      description: "Enhances the quality of social media campaigns by providing structure.",
      color: "text-[#2593DA]"
    }
  ];
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-light leading-tight">
            Benefits of Using a Social<br />Media Content Planner
          </h1>
        </div>
